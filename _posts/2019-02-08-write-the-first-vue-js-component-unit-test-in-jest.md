...
date: 2019-02-08
categories: [vue, TDD]
tags: [translations, vue, jest, TDD, Alex Jover]
comments: true
share: true
---
...
> <a href="https://leanpub.com/testingvuejscomponentswithjest" alt="Test Vue.js components with Jest"><img width="180" src="https://alexjoverm.github.io/images/vuejest.jpg"></a><br> > [Alex Jover](https://alexjover.com/blog/)씨의 책에서는 vue-test-utils와 Jest의 최신 버전으로 업데이트 된 이 글의 내용을 확인하실 수 있습니다. [책 사러가기](https://leanpub.com/testingvuejscomponentswithjest)
...
<template>
  <ul>
    <li v-for="message in messages">{% raw %}{{ message }}{% endraw %}</li>
  </ul>
</template>
